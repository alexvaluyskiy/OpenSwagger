...
using OpenSwagger.AspNetCore.ApiExplorer.Tests.Namespace1;
using OpenSwagger.AspNetCore.ApiExplorer.Tests.TestFixtures.Extensions;
...
namespace OpenSwagger.AspNetCore.ApiExplorer.Tests.Generator
{
    public class SchemaRegistryTests
    {
        ...
        public void GetOrRegister_ReturnsJsonReference_ForComplexTypes()
        {
            ...
            Assert.Equal("#/components/schemas/ComplexType", reference.Ref);
        }
        ...
        public void GetOrRegister_SupportsOptionToCustomizeSchemaIds()
        {
            var subject = Subject(c =>
            {
                c.SchemaIdSelector = (type) => type.FriendlyId(true).Replace("OpenSwagger.AspNetCore.ApiExplorer.Tests.", "");
            });

            var jsonReference1 = subject.GetOrRegister(typeof(ConflictingType));
            var jsonReference2 = subject.GetOrRegister(typeof(Namespace2.ConflictingType));

            Assert.Equal("#/components/schemas/Namespace1.ConflictingType", jsonReference1.Ref);
            Assert.Equal("#/components/schemas/Namespace2.ConflictingType", jsonReference2.Ref);
        }
        ...
        public void GetOrRegister_HandlesCompositeTypes()
        {
            ...
            Assert.Equal("#/components/schemas/ComplexType", rootSchema.Properties["Property1"].Ref);
            Assert.Equal("array", rootSchema.Properties["Property2"].Type);
            Assert.Equal("#/components/schemas/ComplexType", rootSchema.Properties["Property2"].Items.Ref);
        ...
        public void GetOrRegister_HandlesNestedTypes()
        {
            ...
            Assert.NotNull(rootSchema);
            Assert.Equal("object", rootSchema.Type);
            Assert.Equal("#/components/schemas/NestedType", rootSchema.Properties["Property1"].Ref);
        ...
        public void GetOrRegister_Errors_OnConflictingClassName()
        {
            ...
            subject.GetOrRegister(typeof(ConflictingType));
